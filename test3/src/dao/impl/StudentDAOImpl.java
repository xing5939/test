...
public class StudentDAOImpl implements StudentDAO{
	...
	public Student findById(java.lang.Integer id) {
		...
		try {
			Student instance = (Student) getCurrentSession().get("vo.Student",
					id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List<Student> findByExample(Student instance) {
		...
		try {
			List<Student> results = (List<Student>) getCurrentSession()
					.createCriteria("vo.Student").add(create(instance)).list();
	...
	public List<Student> findByNumber(Object number) {
